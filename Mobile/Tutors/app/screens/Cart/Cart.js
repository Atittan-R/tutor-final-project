  ...
  const [User, setUser] = useState([
    {
      ...
      checkedAll: false,
      product: [
        { id: 1, name: "Database", price: 450, checked: checked },
        { id: 2, name: "Compro1", price: 500, checked: checked },
      ],
    },
    {
      id: 2,
      ...
      checkedAll: false,
      product: [
        { id: 1, name: "Eng", price: 450, checked: checked },
        { id: 2, name: "Compro2", price: 500, checked: checked },
      ],
    },
    {
      id: 3,
