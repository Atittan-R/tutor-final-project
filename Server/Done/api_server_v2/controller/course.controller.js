...
exports.findOneCourse = async (req, res) => {
    ...
    try {
      const student = await Course.findByPk(id, {
        //   attributes: {
        //     include: [
        //       Sequelize.fn("COUNT", Sequelize.col("courseEnroll.id")),
        //       "courseEnrollCount",
        //     ],
        //   },
        include: [
          ...
          },
          {
            ...
            include:[
                {
              model:Tutor,
              attributes:['firstname',"lastname","email","phoneNumber","major","experience","date_of_birth","lineId","rate"],
                }
            ],
            as: "tutors",
          },
      ...
      const course = await student.dataValues;
      const courseEnroll = await student.dataValues.courseEnroll[0];
      res.status(202).send({ course,courseEnroll });
    } catch (e) {
